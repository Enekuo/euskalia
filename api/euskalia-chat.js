...
const FREE_ASSISTANT_DAILY_REQUESTS = Number(process.env.FREE_ASSISTANT_DAILY_REQUESTS || 10);
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ===== Límite de tamaño total del historial =====
    ...
    // Reservamos el slot del minuto antes de llamar a OpenAI
