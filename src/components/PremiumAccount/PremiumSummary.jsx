          ...
          >
                    ...
                    {urlInputOpen && (
                      <div className="mb-4 rounded-xl border border-slate-300 p-3 bg-white">
                        <textarea
                          ...
                          placeholder={tr(
                            "premiumSummary.paste_urls_placeholder",
            ...
            <section className="relative h-[600px] rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm overflow-hidden -ml-px">
              ...
              {/* Resultado / errores / loader */}
                   ...
                   <div className="px-6 pt-24 pb-6 max-w-3xl mx-auto">
                    {errorMsg && (
                      ...
                      <>
                        ...
                        {(() => {
                          ...
                          return (
                            <>
                              {savedToLibrary && (
                                <p className="absolute bottom-[140px] right-6 text-xs text-emerald-600">
                                  {librarySavedMessage}
                                </p>
                              )}

                              <div className="absolute bottom-24 right-6 z-20 flex items-center gap-4">
