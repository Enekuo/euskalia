...
export default function PremiumLibrary() {
    ...
    switch (type) {
      ...
      case "paraphraser":
        return {
          ...
          href: "/cuenta-premium/parafraseador",
        };
      case "humanizer":
        return {
          label: tr("library_create_humanizer", "Crear humanizado"),
          href: "/cuenta-premium/humanizador",
        };
  ...
  const createDocAndOpen = (kind, titleFallback) => {
    ...
    navigate(`/cuenta-premium/biblioteca/${id}`);
  };
