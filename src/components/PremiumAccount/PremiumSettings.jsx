  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, (user) => {
      ...
      try {
        ...
        if (uid) {
          const raw = localStorage.getItem(`euskalia:premium:notifications:${uid}`);
          if (raw) {
      ...
      try {
        ...
        if (uid) {
          localStorage.setItem(
            `euskalia:premium:notifications:${uid}`,
      ...
      <form onSubmit={saveAll} className="space-y-8">
          ...
          <div className="space-y-3">
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {tr("settings_notifications_product_hint", "Novedades, mejoras y avisos importantes.")}
                </p>
              </div>
            </label>
            ...
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {tr("settings_notifications_tips_hint", "Tips rápidos para aprovechar Euskalia.")}
                </p>
              </div>
            </label>
            ...
            <label className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">
                  {tr("settings_notifications_billing_hint", "Recibos, avisos de pago y cambios de plan.")}
                </p>
              </div>
            </label>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6">
          <div className="mb-4">
            ...
            <p className="text-slate-600 text-sm mt-1">
              {tr("settings_plan_desc", "Consulta el estado de tu plan actual.")}
            </p>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 overflow-hidden">
            <div className="flex items-center justify-between px-4 py-3">
              ...
              <div className="text-sm font-semibold text-slate-900">
                {tr("settings_plan_value_premium", "Premium")}
              </div>
            </div>
