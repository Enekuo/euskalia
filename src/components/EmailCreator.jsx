...
"NO añadas hechos, nombres, fechas, cantidades, empresas o contexto que el usuario no haya mencionado.",
"NO cambies el significado real del mensaje.",
"",
"PERO sí debes:",
"- corregir errores ortográficos y gramaticales.",
"- mejorar frases mal escritas o torpes.",
"- reorganizar el texto para que suene natural y profesional.",
"- convertir notas rápidas en frases completas y bien redactadas.",
"- mejorar claridad, fluidez y tono.",
"",
"Puedes reformular completamente las frases SI el significado sigue siendo exactamente el mismo.",
"",
"Si un campo está vacío, resuélvelo de la forma más neutra y mínima posible, sin inventar información nueva.",
...
<h1 className="sr-only">
  Generador de emails con IA en euskera
</h1>
          ...
          >
            ...
            <section className="relative h-[550px] pb-[100px] rounded-2xl bg-white ring-1 ring-slate-200 shadow-sm overflow-hidden -ml-px">
              <div className="min-h-[44px] sm:h-11 flex flex-col sm:flex-row items-center sm:items-center justify-center sm:justify-between px-3 sm:px-4 py-2 sm:py-0 gap-3 border-b border-slate-200 bg-slate-50/60">
                <div className="flex items-center justify-center gap-2 min-w-0 w-full sm:w-auto overflow-x-auto sm:overflow-visible">
                  <LengthTab
                ...
                <div className="flex items-center gap-1 w-full sm:w-auto pl-4">
                  <DropdownMenu>
  ...
  title={
    copiedFlash
      ? tr("emailCreator.copied", "Copiado")
      : tr("emailCreator.copy", "Copiar")
  }
                        ...
                        {result && (
                          <>
                            ...
                            <ExpandModal
                              ...
                              title={emailSubject || tr("emailCreator.result_title", "Emaila")}
                              content={result}
